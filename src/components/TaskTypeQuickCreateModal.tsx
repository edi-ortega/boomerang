...
interface TaskTypeQuickCreateModalProps {
  onClose: () => void;
  onCreate?: (type: any) => void;
}

export default function TaskTypeQuickCreateModal({ onClose, onCreate }: TaskTypeQuickCreateModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error("Não foi possível criar o tipo de tarefa.");
    } finally {
      setIsSaving(false);
    }
  };
        ...
        <CardHeader className="border-b border-border">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-foreground">Novo Tipo de Tarefa</CardTitle>
            </div>
            <Button
              variant="ghost"
              size="icon"
